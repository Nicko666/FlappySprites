...
public class MyFileController<T> where T : class
{
    ...
    public MyFileController(string dataDirPath, string dataFileName)
    {
    ...
    public MyFileController(string dataDirPath, string dataFileName, string encryptionCodeWord)
    {
        this.dataDirPath = dataDirPath;// Application.persistentDataPath;
        this.dataFileName = dataFileName;
